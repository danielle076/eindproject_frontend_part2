...
function Vegetarian() {
    ...
    async function foodData() {
        ...
        try {
            const result = await axios.get(`https://api.spoonacular.com/mealplanner/generate?apiKey=${process.env.REACT_APP_API_KEY}&timeFrame=day&targetCalories=${calories}&diet=vegetarian`);
            setFood(result.data);
        } catch (error) {
